...
datadirout = datadir_top + '/b020_sim_0.5Hz/'



frun_template = 'b020_run_template.sh'
fsw4input_template = 'b020_template.sw4input'

fcsv = datadir_in_csv + '/c001_source_loc.csv'
fsta_csv = datadir_in_csv + '/c001_sta_sim.csv'

fout_sw4input_ = datadirout + '/b020_EQ_%s.sw4input'
fout_run_ = datadirout + 'b020_run_EQ_%s.sh'
